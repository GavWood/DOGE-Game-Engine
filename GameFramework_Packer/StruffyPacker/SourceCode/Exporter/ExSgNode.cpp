...
void ExSgNode::CopyAttributes()
{
	...
	BtU32 nInstanceSize = 0;
	{
		BtU32 nIndividualInstanceSize = 0; // TODO
		BtU32 nearestPowerOf2 = BtNearestPowerOf2(nIndividualInstanceSize);
		nInstanceSize += nearestPowerOf2 * 2;
	}
