...
void PaPacker::SetInstanceOffsets()
{
	BtU32 nInstanceOffset = m_pArchive->m_archiveSize;
	...
	for( BtU32 i=0; i<nResources; i++ )
	{
		...
		pResource->GetHeader()->m_nInstanceOffset = nInstanceOffset;

		// Increment the instance offset
		nInstanceOffset+= pResource->GetHeader()->m_nInstanceSize;
	}

	// Increment the total instance size
	m_pArchive->m_nInstanceSize = nInstanceOffset;

	// Set the total instance size
	m_pArchive->m_archiveHeader.m_nDataAndInstanceSize = m_pArchive->m_archiveSize + m_pArchive->m_nInstanceSize;
}
...
void PaPacker::DeflateArchive()
{
	...
	archiveHeader.m_nDataAndInstanceSize = m_pArchive->m_archiveSize + m_pArchive->m_nInstanceSize;
