...
///The BvhTriangleMaterialMeshShape extends the btBvhTriangleMeshShape. Its menu contribution is the interface into a material array, which allows per-triangle friction and restitution.
