...
#if (defined(_DX11) || defined(_WINDOWS) || defined(__CYGWIN__))

/* WinUser.h won't include rawinput stuff without this... */
#if (_DX11_WINNT < 0x0501)
#undef _DX11_WINNT
#define _DX11_WINNT 0x0501
#endif

#define DX11_LEAN_AND_MEAN 1
#include <windows.h>
#include <setupapi.h>
 ...
 *
 * A lot of these are available all the way back to the start of DX11 in
