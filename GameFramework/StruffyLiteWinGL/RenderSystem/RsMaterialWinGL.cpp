...
{
	Render(primitiveType, pVertex, vertexCount, sortOrder, BtNull, isVertexCopied);
}

//----------------------------------------------------------------------------
// Render

void RsMaterialWinGL::Render( RsPrimitiveType primitiveType, RsVertex3 *pVertex, BtU32 vertexCount, BtU32 sortOrder, BtU32 *pMemory, BtBool isVertexCopied )
{
	// Cache the impl
