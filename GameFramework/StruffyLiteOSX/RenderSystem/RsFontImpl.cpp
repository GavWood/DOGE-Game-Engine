...
void RsFontWinGL::FixPointers( BtU8 *pFileData, BaArchive *pArchive )
{
	// Set the file data
...
void RsFontWinGL::SetNewLineRatio( BtFloat ratio )
{
	m_ratio = ratio;
}
...
// virtual
MtVector2 RsFontWinGL::GetDimension( const BtChar* szText )
{
...
// virtual
void RsFontWinGL::Render( const MtVector2& v2Position,
...
// virtual
MtVector2 RsFontWinGL::Render( const MtVector2& v2StartPosition,
							  const RsColour &colour,
							  const BtChar* szText,
							  BtU32 sortOrder )
{
...
void RsFontWinGL::Render( RsFontRenderable *pFontRenderable )
{
	// Cache the shader
