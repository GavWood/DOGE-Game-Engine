...
void RsFlashOSX::FixPointers( BtU8 *pFileData, BaArchive *pArchive )
{
	// Set the file data
...
//virtual
void RsFlashOSX::CreateOnDevice()
{
...
//virtual 
void RsFlashOSX::RemoveFromDevice()
{
	delete m_pJSON;
}
...
BtU32 RsFlashOSX::GetFrameNumber()
{
...
void RsFlashOSX::SetLooping( BtBool isLooping )
{
...
// virtual
void RsFlashOSX::Update( BtFloat tick )
{
...
// virtual
void RsFlashOSX::Render( const MtVector2& v2StartPosition, BtU32 sortOrder )
{
