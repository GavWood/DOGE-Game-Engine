...
public:
	...
	static HlItem*					AddFloat( HlItem *pParent, BtChar *name, BtFloat *value, BtBool isReadOnly, HlUnits unitsSystem = HLUnits_StandardIndex, BtFloat minFloat = 0.0f, BtFloat maxFloat = 1.0f );
	...
	static HlItem*					AddUInt(HlItem *pParent, BtChar *name, BtU32 *value, BtBool isReadOnly);
	...
	static void						SetConsoleText(BtChar *console);
	static void						AddConsoleText(BtChar *console);
