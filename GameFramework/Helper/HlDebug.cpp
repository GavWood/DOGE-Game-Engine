...
HlItem* HlDebug::AddFloat( HlItem *pParent, BtChar *name, BtFloat *pValue, BtBool isReadOnly, HlUnits unitsSystem, BtFloat minFloat, BtFloat maxFloat )
{
	HlItem item;
	BtStrCopy( item.m_name, 256, name );
...
HlItem* HlDebug::AddUInt(HlItem *pParent, BtChar *name, BtU32 *pValue, BtBool isReadOnly )
{
...
void HlDebug::SetConsoleText(BtChar *console)
{
...
void HlDebug::AddConsoleText(BtChar *console)
{
