...
//virtual
void RsSpriteImpl::FixPointers( BtU8 *pFileData, BaArchive *pArchive )
{
...
void RsSpriteImpl::CreateOnDevice()
{
	int a=0;
	a++;
}
...
void RsSpriteImpl::RemoveFromDevice()
{
	int a=0;
	a++;
}
...
BtU32 RsSpriteImpl::GetNumSprites() const
{
...
MtVector2 RsSpriteImpl::GetDimension( BtU32 iSprite ) const
{
...
void RsSpriteImpl::Render( BtBool isFlipX, const MtVector2& v2CurrentPosition, BtU32 spriteIndex, BtFloat rotation, BtU32 sortOrder )
{
...
void RsSpriteImpl::Render( BtBool isFlipX, const MtVector2& v2CurrentPosition, const MtVector2& v2Dimension, BtU32 spriteIndex, BtFloat rotation, const RsColour& colour, BtU32 sortOrder )
{
	// Cache the texture
	RsTextureImpl *pTexture = (RsTextureImpl*)m_pFileData->m_pTexture;
...
void RsSpriteImpl::Render( BtBool isFlipX, const MtVector2& v2CurrentPosition, BtU32 spriteIndex, BtFloat rotation, const RsColour& colour, BtU32 sortOrder )
{
	// Cache the sprite
	BaSprite& sprite = m_pFileData->m_sprites[spriteIndex];
...
void RsSpriteImpl::Render( RsSpriteRenderable *pRenderable )
{
	// Cache the shader
