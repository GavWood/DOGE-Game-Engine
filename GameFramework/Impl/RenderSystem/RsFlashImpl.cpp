...
void RsFlashImpl::FixPointers( BtU8 *pFileData, BaArchive *pArchive )
{
	// Set the file data
...
//virtual
void RsFlashImpl::CreateOnDevice()
{
...
//virtual 
void RsFlashImpl::RemoveFromDevice()
{
	delete m_pJSON;
}
...
BtU32 RsFlashImpl::GetFrameNumber()
{
...
void RsFlashImpl::SetLooping( BtBool isLooping )
{
...
// virtual
void RsFlashImpl::Update( BtFloat tick )
{
...
// virtual
void RsFlashImpl::Render( const MtVector2& v2StartPosition, BtU32 sortOrder )
{
		...
		else if( BtStrCompare( pCommandString, "vertex" ) )
		{
...

			{
				...
				*/
				...
				pTextureRenderable->m_pTexture  = (RsTextureImpl*)pTexture;
